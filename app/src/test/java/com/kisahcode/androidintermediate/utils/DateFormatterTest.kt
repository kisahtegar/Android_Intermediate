...
/**
 * Test cases for the DateFormatter class.
 */
class DateFormatterTest {

    /**
     * Test case to verify correct formatting of date in ISO 8601 format.
     */
    @Test
    ...
    /**
     * Test case to verify that an error is thrown when the date is in the wrong format.
     */
    @Test
    ...
    /**
     * Test case to verify that an error is thrown when an invalid timezone is provided.
     */
    @Test
